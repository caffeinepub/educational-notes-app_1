...
import type { AnalyticsView as _AnalyticsView, GameState as _GameState, GameType as _GameType, HighScore as _HighScore, MemoryTestHighScore as _MemoryTestHighScore, MemoryTestState as _MemoryTestState, ScienceNote as _ScienceNote, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAnalytics(arg0: string): Promise<AnalyticsView | null> {
        if (this.processError) {
            try {
    ...
    async recordGamePlay(arg0: string): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_GameState_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _GameState): GameState {
...
function from_candid_HighScore_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _HighScore): HighScore {
...
function from_candid_opt_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ScienceNote]): ScienceNote | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_GameState]): GameState | null {
    return value.length === 0 ? null : from_candid_GameState_n14(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [Array<_MemoryTestHighScore>]): Array<MemoryTestHighScore> | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_MemoryTestState]): MemoryTestState | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_AnalyticsView]): AnalyticsView | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        memoryTestRecords: record_opt_to_undefined(from_candid_opt_n16(_uploadFile, _downloadFile, value.memoryTestRecords)),
        score: value.score,
        memoryTestState: record_opt_to_undefined(from_candid_opt_n17(_uploadFile, _downloadFile, value.memoryTestState)),
...
function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_HighScore>): Array<HighScore> {
    return value.map((x)=>from_candid_HighScore_n21(_uploadFile, _downloadFile, x));
}
